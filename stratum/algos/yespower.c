...
static const yespower_params_t yespower_1_0_LITB = {YESPOWER_1_0, 2048, 32,"LITBpower: The number of LITB working or available for proof-of-work mini", 73};
...
{
	yespower_tls(input, 80, &yespower_1_0_LITB, (yespower_binary_t *)output);
}
